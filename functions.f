...
!     binary properties: assume all BHs have same mass!
     ...
     &     *(1./(1.+121./304.*x**2))**(870./2299.)*(1.+x)**(0.7969)
      ...
      Ngw=((7./10.*(1./agw)**(10./7.)*g**2)-
     &     (Mb**(1./3.)/pi**(2./3.)
     &     /agw*F))/(7./10.*(1./agw)**(10./7.)*g**2)    
      if(Ngw.lt.0)Ngw=0.d0
      
      elcap=2.*(Rs/agw)**(5./7.)
      Ncap=(elcap-(Mb**(1./3.)/pi**(2./3.)
     &     /agw*F)*5./7.)/elcap     
      if(Ncap.lt.0)Ncap=0.d0
...
!     binary properties
      ...
      Pcap=K2/agw**(5./7.)
      Pin=Pgw+Pcap
      Pex=(0.7e-1/aej)**(8./7.)*(m1*m2*Mb*s/1.e10/1.e3
     &     )**(2./7.)
      Pej=(1.-Pin)*Pex
      if(Pej.lt.0)Pej=0.
     ...
     &     *(1./(1.+121./304.*x**2))**(870./2299.)*(1.+x)**(0.7969)
      ...
      Nej=(((0.7e-1/aej)**(8./7.)*(m1*m2*Mb/1.e3*s/1.e10)**(2./7.))
     &     -(Mb/pi**2)**(1./3.)*F/aej)/
     &     ((0.7e-1/aej)**(8./7.)*(m1*m2*Mb/1.e3*s/1.e10)**(2./7.))      
      if(Nej.lt.0)Nej=0
...
!     binary properties
     ...
     &     ((0.7e-1/aej)**(8./7.)*(m1*m2*Mb/1.e3*s/1.e10)**(2./7.))      
      ...
      Pex=(0.7e-1/aej)**(8./7.)*(m1*m2*Mb*(s-X0)/1.e10/1.e3
     &     )**(2./7.)
      Pej=(1.-Pin)*Pex          !all mergers with very short merger time      
      
      Nej=(((0.7e-1/aej)**(8./7.)*(m1*m2*Mb/1.e3*(s-X0)/1.e10)**(2./7.))
     &     -(Mb/pi**2)**(1./3.)*F/aej)/
     &     ((0.7e-1/aej)**(8./7.)*(m1*m2*Mb/1.e3*(s-X0)/1.e10)**(2./7.)) 
      if(Nej.lt.0)Nej=0
      F2=Pej*Nej
